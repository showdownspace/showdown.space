...
sponsors:
  ...
  - name: Phoomparin Mano
    url: https://poom.dev
    image: https://usercontent.creatorsgarten.org/c/v1732293255/644c35a6802c02345887f156/image_yujxmk.webp
    contributed: prizes.
    links:
      - name: Website
        url: https://poom.dev
      - name: Facebook
        url: https://www.facebook.com/phoomparin.mano
ranking:
  finals:
    - score: 181
      participant:
    ...
    - score: 97
      participant:
        ...
        teamMembers:
          ...
          - name: title
          - name: golfapipol
            url: https://github.com/golfapipol
    - score: 74
      participant:
        handle: หมูเด้ง
        teamMembers:
    ...
    - score: 67
      participant:
        ...
        teamMembers:
          - name: S
            url: https://github.com/cerberus
    - score: 44
      participant:
        handle: Bug Hunters
        teamMembers:
          - name: Kong
            url: https://github.com/NoobLeader
          - name: Jay
    - score: 34
      participant:
        handle: ม้าบ้านงาน practitioner
        teamMembers:
          - name: Mew
            url: https://github.com/mewxz029
          - name: Turk
            url: https://github.com/puncharasx
    - score: 30
      participant:
        handle: BotCrusher
        teamMembers:
    ...
    - score: 16
      participant:
        ...
        teamMembers:
          - name: Pat
            url: https://github.com/slothPete7773
          - name: Korn
    ...
    - score: 14
      participant:
        ...
        teamMembers:
          - name: new5558
            url: https://github.com/new5558
          - name: KodPhraBoy
          - name: ryugyu
    - score: 13
      participant:
        handle: ยุทธชัย ไก่ทอด
        teamMembers:
          - name: Morjor
            url: https://github.com/mmayyiisuay
          - name: NongJupz
            url: https://github.com/KatanyooThanoosin
---
...
In this example challenge, you must complete all of these 3 tasks within the time limit:

1. Filling in the form with a given text (no copy-pasting allowed).
2. Check a single checkbox.
3. Click a button 10 times.
...
[link_1_hunting]: https://showdownspace-rpa-challenge.vercel.app/challenge-hunting-fed83d58/
[link_2_seven]: https://lemon-meadow-0c732f100.5.azurestaticapps.net/ssg
[link_3_blog]: https://docs.google.com/forms/d/e/1FAIpQLSespJgfjZc0ifw7As_9Y8zYo5UZheLmEPnoGtrJaSqFyy7rNw/viewform?usp=sf_link
[link_4_robot]: https://showdownspace-rpa-challenge.vercel.app/challenge-robot-d34b4b04/
[link_5_button]: https://showdownspace-rpa-challenge.vercel.app/challenge-buttons-a9808c5e/
[link_6_typing]: https://learn.manoonchai.com/
[link_7_towers]: https://showdownspace-rpa-challenge.vercel.app/challenge-towers-6d3a20be/
[link_8_calendar]: https://showdownspace-rpa-challenge.vercel.app/challenge-mui-168af805/

### `1_hunting`

<div class="indent">

You are given 5 numbers to click and 64 boxes. Click on those boxes. The catch? You have to hover over the boxes to find out what number is in them. The boxes are shuffled every time you refresh the page.

**Challenge by:** [@dtinth][] \
**Time limit:** 20 seconds \
**Number of finishers:** 9 \
**First finished by:** MyGeek

[&rarr; Try out the challenge][link_1_hunting]
...
You are given a 6 digit number and a seven segment display. You have to click on the segments to display the number.

**Challenge by:** [@narze][] \
**Time limit:** 5 seconds \
**Number of finishers:** 3 \
**First finished by:** NPM

[&rarr; Try out the challenge][link_2_seven]
...
- A spreadsheet that contains a list of articles and their word counts.
- A URL to a blog that contains these articles.

However, there are 3 problems in the blog:

- There is a missing article.
- There is a duplicate article.
- There is an article with a word count that does not match the spreadsheet.

Your mission is to find these problems and report them.

**Challenge by:** [@dtinth][] \
**Number of finishers:** 2 \
**First finished by:** NPM

[&rarr; Try out the challenge][link_3_blog]
...
Navigate from the top left to the bottom right.

**Challenge by:** [@dtinth][] \
**Time limit:** 120 seconds \
**Number of finishers:** 2 \
**First finished by:** หมูเด้ง
...
<div class="indent">
Answer 100 simple math questions, involving addition, subtraction, multiplication, and division, inputting the numbers using the provided buttons.
...
Complete any lesson on [Learn Manoonchai](https://learn.manoonchai.com/) and achieve a WPM of at least 420.69.

**Challenge by:** [@narze][] \
**Number of finishers:** 2 \
**First finished by:** MyGeek

[&rarr; Try out the challenge][link_6_typing]
...
You are given 24 numbers (displayed as towers, i.e. vertical bars). You have to sort them in ascending order (from shortest to tallest).
...
[&rarr; Try out the challenge][link_7_towers]
...
Given a list of 20 dates and times, automate the date-time picker to select the correct date and time and submit all of them.

**Challenge by:** [@dtinth][] \
**Time limit:** 60 seconds \
**Number of finishers:** 0 \
**First finished by:** (none)

[&rarr; Try out the challenge][link_8_calendar]
